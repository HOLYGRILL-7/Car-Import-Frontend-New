...
export const ABOUT_CONTENT = {
  ...
  investors: {
    ...
    description: 'Backed by leading venture capital firms and strategic partners who believe in our mission',
    list: [
      {
        id: 'bendub-1',
        name: 'Bendub Capital',
