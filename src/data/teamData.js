...
export const TEAM_CONTENT = {
  ...
  joinTeam: {
    ...
    description: "We're always looking for talented individuals who are passionate about excellence and innovation.",
...
export const PRESS_CONTENT = {
  ...
  mediaContact: {
    ...
    description: 'For press inquiries, interviews, or media kits, please contact our communications team.',
